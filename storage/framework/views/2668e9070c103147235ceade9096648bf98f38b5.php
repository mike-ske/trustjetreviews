...
<head>
	<meta charset="UTF-8" />
	<title>Embedded Reviews for <?php echo e($c->url); ?></title>
	...
	html {
		...
		background: <?php echo e(Options::get_option('generalBG_' . $c->id , '#000032' )); ?>;
		color: <?php echo e(Options::get_option('generalFC_' . $c->id , '#FFFFFF' )); ?>;
	}
	body {
		margin:  0;
		background: <?php echo e(Options::get_option('generalBG_' . $c->id , '#000032' )); ?>;
	...
	figure.testimonial {
		...
		color: <?php echo e(Options::get_option('testiFG_' . $c->id , '#FFFFFF' )); ?>;
	}
	figure.testimonial * {
	...
	figure.testimonial section {
		background-color: <?php echo e(Options::get_option('testiGB_' . $c->id , '#ffffff' )); ?>;
		display: block;
		font-size: 16px;
		font-weight: 400;
		line-height: 1.5em;
		...
		position: relative;
		color: <?php echo e(Options::get_option('testiFC_' . $c->id , '#333' )); ?>;
	}
	...
	figure.testimonial .peopl {
		margin: 0;
		color: <?php echo e(Options::get_option('generalFC_' . $c->id , '#333' )); ?>;
	...
	.full-review-link {
		color: <?php echo e(Options::get_option('urlFC_' . $c->id , '#FFFFFF' )); ?>;
	}
	.slick-prev:before,
	.slick-next:before {
	  color: <?php echo e(Options::get_option('generalFC_' . $c->id , '#FFFFFF' )); ?>;
...
<section>
    <div style="display:flex;column-gap:19px;justify-content:center;align-items:center;margin:auto">
        <div>
            ...
            <?php elseif( $r->rating === 1 || $r->rating === 1.2 || $r->rating === 1.3 || $r->rating === 1.4 || $r->rating === 1.5 || $r->rating === 1.6 || $r->rating === 1.7 ): ?>
                <strong style="font-weight:500">Bad</strong>
            <?php elseif(  $r->rating === 2 || $r->rating === 2.2 || $r->rating === 2.3 || $r->rating === 2.4 || $r->rating === 2.5 || $r->rating === 2.6 || $r->rating === 2.2 ): ?>
                <strong style="font-weight:500">Poor</strong>
            <?php elseif(  $r->rating === 3 || $r->rating === 3.2 || $r->rating === 3.3 || $r->rating === 3.4 || $r->rating === 3.5 || $r->rating === 3.6 || $r->rating === 3.7): ?>
                <strong style="font-weight:500">Good</strong>
            <?php elseif(  $r->rating === 4 || $r->rating === 4.2 || $r->rating === 4.3 || $r->rating === 4.4 || $r->rating === 4.5 || $r->rating === 4.6 || $r->rating === 4.7): ?>
...
<small style="text-align:center;display:flex;justify-content:center">Rated &nbsp;<b><?php echo e(number_format($r->rating,2)); ?>/5.00 &nbsp;&nbsp;</b> <strong>|</strong> <img src="/public/star/logo.png" style="margin:0 10px;height:20px" alt=""> <strong>Trustjet Review</strong> </small> <br> 
<strong><?php echo e(substr($r->review_title, 0, 24)); ?></strong><br>

<div id="section">"<?php echo e(substr( $r->review_content, 0, 99 )); ?>"</div>

</section>
<div class="peopl">
	<h3><?php echo e($r->user->name); ?></h3>
</div>
<p>
<a href="<?php echo e($c->slug); ?>" style="font-size:12px;" target="_blank" class="full-review-link"><?php echo e(__('Read full review')); ?></a>
</p><!-- /.btn -->
</figure>
</div>

<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
	<?php echo e(__('No reviews for this company yet')); ?>
...
</html><?php /**PATH /home2/trustjetreviews/public_html/resources/views/iframe.blade.php ENDPATH**/ ?>