...
use App\Http\Controllers\SocialMediaPostingController;
...
// Votes
Route::get( 'vote/review/{review}', 'VoteController' )->name( 'vote' );
...
Route::any( 'email/resend', '\App\User@resend' );
...
Route::group(['prefix' => 'admin', 'middleware' => 'App\Http\Middleware\AdminMiddleware'], function () {
    ...
    Route::post( 'companies/update/{id}', 'AdminController@updateCompany' );
...
Route::get('social-auth/{provider}/callback', [SocialAuthController::class, 'callbackProvider']);

// OAuth = facebook
// OAuth linkedIn

// social media posting with open Graph -->
Route::get('mediapost/{url}', [SocialMediaPostingController::class, 'getmetadata'])->name('mediapost');