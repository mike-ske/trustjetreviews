			...
			<div class="row">
				<div class="col-6">
		            <h5 class="text-warning">
                        ...
                        @if( $site->reviews->avg('rating') === 0 )
                            <img src="/public/star/6.svg" width="300"style="width:120px" alt="">
                        @elseif( $site->reviews->avg('rating') === 1.5 || $site->reviews->avg('rating') === 1.6 || $site->reviews->avg('rating') === 1.7 || $site->reviews->avg('rating') === 1.7 || $site->reviews->avg('rating') === 1.8 )
                            <img src="/public/star/15.svg" width="300"style="width:120px" alt="">
                        @elseif( $site->reviews->avg('rating') === 2.5 || $site->reviews->avg('rating') === 2.6 || $site->reviews->avg('rating') === 2.7 || $site->reviews->avg('rating') === 2.7 || $site->reviews->avg('rating') === 2.8 )
                            <img src="/public/star/25.svg" width="300"style="width:120px" alt="">
                        @elseif( $site->reviews->avg('rating') === 3.5 || $site->reviews->avg('rating') === 3.6 || $site->reviews->avg('rating') === 3.7 || $site->reviews->avg('rating') === 3.7 || $site->reviews->avg('rating') === 3.8 )
                            <img src="/public/star/35.svg" width="300"style="width:120px" alt="">
                        @elseif( $site->reviews->avg('rating') === 4.5 || $site->reviews->avg('rating') === 4.6 || $site->reviews->avg('rating') === 4.7 || $site->reviews->avg('rating') === 4.7 || $site->reviews->avg('rating') === 4.8 )
