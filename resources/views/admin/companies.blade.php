	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="{{ route('reviewsForSite', ['site' => $c->id]) }}" target="_blank">View Listing</a>
			</td>
			<td>
				{{ $c->business_name }}<br>
			...
			<td>
				<a href="/admin/companies/approve/{{ $c->id }}">Approve</a>
				<br>
				<a href="/admin/companies/delete/{{ $c->id }}" onclick="return confirm('Are you sure?')">
					Delete
				</a>
			</td>
		</tr>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<br>
				<a href="/admin/companies/delete/{{ $c->id }}" onclick="return confirm('Are you sure you want to remove this company and all its reviews?')">Delete</a>
			</td>
		</tr>
		@endforeach
	</tbody>
