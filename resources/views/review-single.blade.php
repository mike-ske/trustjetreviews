        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3" id="srht">
                    <img id="srht_img" src="{{ $review->screenshot }}" alt="" class="img-responsive" style="max-width: 100%;">
                </div>
                <div class="col-md-5">
                    ...
                    <h2 class="text-warning">
                        ...
                        @if( $review->reviews->avg('rating') === 0 )
                            <img src="/public/star/6.svg" width="300"style="width:120px" alt="">
                        @elseif( $review->reviews->avg('rating') === 1.5 || $review->reviews->avg('rating') === 1.6 || $review->reviews->avg('rating') === 1.7 || $review->reviews->avg('rating') === 1.7 || $review->reviews->avg('rating') === 1.8 )
                            <img src="/public/star/15.svg" width="300"style="width:120px" alt="">
                        @elseif( $review->reviews->avg('rating') === 2.5 || $review->reviews->avg('rating') === 2.6 || $review->reviews->avg('rating') === 2.7 || $review->reviews->avg('rating') === 2.7 || $review->reviews->avg('rating') === 2.8 )
                            <img src="/public/star/25.svg" width="300"style="width:120px" alt="">
                        @elseif( $review->reviews->avg('rating') === 3.5 || $review->reviews->avg('rating') === 3.6 || $review->reviews->avg('rating') === 3.7 || $review->reviews->avg('rating') === 3.7 || $review->reviews->avg('rating') === 3.8 )
                            <img src="/public/star/35.svg" width="300"style="width:120px" alt="">
                        @elseif( $review->reviews->avg('rating') === 4.5 || $review->reviews->avg('rating') === 4.6 || $review->reviews->avg('rating') === 4.7 || $review->reviews->avg('rating') === 4.7 || $review->reviews->avg('rating') === 4.8 )
