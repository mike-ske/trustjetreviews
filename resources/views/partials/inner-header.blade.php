...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-9 col-md-6 no-padding">
        <input type="text" name="searchQuery" class="form-control" placeholder="{{ __('Search for a company') }}" required>
    </div><!-- /.col-7 -->
      <div class="col-md-1 col-2 no-padding">
          <input type="submit" name="searchAction" class="btn" style="background:rgb(13,183,123) !important;"  value="{{ __('Go') }}">
