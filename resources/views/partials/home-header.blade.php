...
<div class="container">
  ...
  <h3 class="text-center">
    <span class="badge " style="color: rgb(255,255,255);">{{ Options::get_option( 'site_belowdescription', 'From People Like You' ) }}</span>
  </h3>
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-8 no-padding">
        <input type="text" name="searchQuery" class="form-control search-padding" placeholder="{{ __('Search for a company') }}" required>
    </div><!-- /.col-7 -->
      <div class="col-md-1 col-2 no-padding">
          <input type="submit" name="searchAction" style="background:rgb(13,183,123) !important;" class="btn btn-block search-btn-padding" value="{{ __('Go') }}">
